...
class Watcher:
    def __init__(self, directory_to_watch):
        ...
        self.observer = Observer(self.directory_to_watch)
    ...
    def run(self):
        try:
            while True:
                if self.first_loop:
                    ...
                    while get_admin:
                        try:
                            ...
                            all_files = self.observer.get_all_files()
                ...
                added, deleted, modified = self.observer.update()
                for f in added:
